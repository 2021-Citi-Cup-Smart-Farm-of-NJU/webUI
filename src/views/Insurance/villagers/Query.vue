<template>
  <div class="container">
    ...
    <div class="sousuo">
      <div class="search">
        <input data-id="search" type="search" alt="search" v-model="input">
    ...
    <div class="content">
      <div class="my-content">
        <div class="my-item" @click="currentIndex=1" :class="currentIndex==1?'action':''">我的表单</div>
        <div class="my-item" @click="currentIndex=2" :class="currentIndex==2?'action':''">我的理赔</div>
      </div>
                ...
                enterprises:[
                    {
                        ...
                        introduction:"政策性保险,政府保费补贴高,自交保费少,保障范围广.只需交纳少量的保费就可解决'靠天吃饭'的后顾之忧",
                        time:"12-01",
                    },
                    {
                        index:1,
...
<style scoped>
  ...
  .box-card{
    ...
    box-shadow: #d3d3d3 5px 5px 5px 5px;
    display: flex;
    flex-direction: column;
    align-items: center;
